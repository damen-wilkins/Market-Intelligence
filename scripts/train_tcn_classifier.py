...
from app.training.tcn_classifier_model import (
    TCNClassifier,
)
from app.training.tcn_classifier_parameter_selector import (
    TCNClassifierParameterSelector,
)
...
MODEL_NAME = "tcn_direction_classifier"
MODEL_VERSION = "tcn_direction_v1"

MODEL_PATH = Path(
    "models/tcn_direction_classifier.pt"
)

VALIDATION_OUTPUT_PATH = Path(
    "models/tcn_direction_validation_predictions.csv"
)
...
def main():
    ...
    metadata = {
        ...
        "experiment_notes": (
            "Direct next-day SPY "
            "UP/FLAT/DOWN TCN classifier. "
            "Hyperparameters selected with "
            "train-only walk-forward CV. "
            "Causal dilated convolutions only. "
