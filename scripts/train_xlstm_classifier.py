...
from app.training.xlstm_classifier_parameter_selector import (
    XLSTMClassifierParameterSelector,
)
...
MODEL_NAME = "xlstm_direction_classifier_breadth"
MODEL_VERSION = "xlstm_direction_breadth_v1"

MODEL_PATH = Path(
    "models/xlstm_direction_classifier_breadth.pt"
)

VALIDATION_OUTPUT_PATH = Path(
    "models/xlstm_direction_breadth_validation_predictions.csv"
)
...
def main():
    ...
    print()
    print(
        "Training final xLSTM breadth candidate "
        "on training data..."
    )
    ...
    metadata = {
        ...
        "experiment_notes": (
            "Direct next-day SPY UP/FLAT/DOWN "
            "classifier using the official NX-AI "
            "xLSTM implementation with mLSTM blocks. "
            "Includes SPY technical features, "
            "VIX/VVIX volatility features, "
            "RSP-relative performance, sector "
            "participation, sector dispersion, "
            "sector rolling correlation, and "
            "sector volume breadth. Hyperparameters "
            "selected using train-only walk-forward "
            "cross-validation. Outer validation used "
            "once. Held-out test not evaluated."
        ),
    }
    ...
    print(
        "xLSTM BREADTH CLASSIFIER RESULT"
    )
    print(
        "================================="
    )
