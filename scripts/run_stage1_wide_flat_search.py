...
EXPERIMENT_NAME = "xlstm_stage1_wide_flat_search_v1"
MODEL_NAME = "xlstm_stage1_wide_flat_search_v1"
CHECKPOINT_PATH = (
    EXPERIMENT_DIRECTORY
    / "stage1_wide_flat_search_v1_checkpoint.json"
)
...
def main():
    print(
        "Loading wide Stage-1 FLAT/MOVE signal dataset..."
    )
    ...
    univariate_path = (
        EXPERIMENT_DIRECTORY
        / f"stage1_univariate_flat_move_auc_v1_{timestamp}.csv"
    )
    univariate.to_csv(
        univariate_path,
        index=False,
    ...
    group_names = list(
        Stage1WideFeatureBuilder.FEATURE_GROUPS
    )
    ...
    summary_path = (
        EXPERIMENT_DIRECTORY
        / f"stage1_wide_flat_search_v1_{timestamp}.csv"
    )
    summary.to_csv(
        summary_path,
        index=False,
    ...
    experiment_path = ExperimentTracker(
        ...
        metrics={
            "best_candidates": summary.head(30).to_dict(
                orient="records"
            ),
        },
        features=list(
    ...
    print(
        "STAGE-1 WIDE FLAT/MOVE SIGNAL SEARCH V1 - TOP 30"
    )
    print(
        "============================================================"
    )
